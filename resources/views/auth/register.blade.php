                ...
                <form method="post" action="{{ route('register') }}">
                    ...
                    <div class="form-group has-icon">
                        ...
                        <div class="position-relative">
                            ...
                            class="form-control form-control-lg @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                    ...
                    <input type="submit" class="btn btn-primary btn-lg btn-block mt-2" value="{{ __('Creer le compte') }}">

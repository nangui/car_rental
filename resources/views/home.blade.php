...
@section('content')
<div class="indigo lighten-2 py-5">
   &nbsp;
</div>
                        ...
                        <div class="grid-3">
                            ...
                            <div class="form-group">
                                ...
                                <input name="site_copyright" id="site_copyright"
                                    type="text" class="form-control" value="{{ $setting->copyright }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-block btn-primary">Sauvegarder les infos</button>
                            </div>
                        </div>
                    </form>
                </div>
